...
<html lang="en">
  ...
  <body class="az-body">
    <div class="az-error-wrapper">
      <h1>404</h1>
      <h2>Oopps. Halaman yang anda akses tidak tersedia.</h2>
      <h6>Mungkin URL yang anda akses salah atau halaman sudah dihapus.</h6>
      <a href="<?php echo base_url() ?>dashboard" class="btn btn-outline-indigo">Kembali ke Home</a>
    </div>
